...
import { Users, Banknote, Wallet, BarChart3 } from "lucide-react";
        ...
        <>
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="card p-5">
              ...
              <p className="mt-2 text-3xl font-bold text-zinc-900">{pendingTotal > 0 ? formatCurrency(pendingTotal) : m.dash.notStarted}</p>
            </div>
          </div>
